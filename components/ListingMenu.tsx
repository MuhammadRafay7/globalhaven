    ...
    <Modal>
      <Menu>
        ...
        >
          <button
            type="button"
            className="w-7 h-7 rounded-full bg-slate-800/50 dark:bg-slate-700/50 backdrop-blur-sm flex items-center justify-center hover:bg-slate-800/70 group transition-all duration-200 z-[5]"
          >
            <BsThreeDots className="h-[16px] w-[16px] text-white transition duration-100" />
          </button>
        </Menu.Toggle>
